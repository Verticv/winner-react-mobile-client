export default function horizontalsScroll(array, tapIdPrefix, scrollWrapperId, buttonIndex, leftScrollShift) {
  ...
  if (scrollWrapper) {
    if (activeTapId > 2) {
      ...
      const leftScrollValue = ((activeTapId - (leftScrollShift || 1.5)) * elementWidth)
