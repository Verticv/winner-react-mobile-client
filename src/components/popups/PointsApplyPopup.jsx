...
const PointsApplyPopup = ({setPopupOpen}) => {
    ...
    return (
        <div style={{width: '73rem', maxWidth: '610px'}} className="h-518px md:h-550px w-610px flex flex-col rounded-lg overflow-hidden">
            ...
            <div className="w-full h-full bg-white px-10px md:px-35px">
                <div className="mt-10px md:mt-40px w-full h-157px rounded-2xl border border-red-e8c2b3 bg-red-ffe9de px-19px pt-17px">
                    <div className="flex items-center h-26px space-x-10px">
                        <img className='w-22px md:w-29px' src={AlertIcon} alt="" />
                        <span className="text-red-ee3c62 font-spoqaMedium text-15px md:text-20px tracking-tight">확인/필독사항</span>
                    </div>
                    <div className="mt-18px flex flex-col space-y-14px text-red-ac6d6d tracking-tight font-spoqaMedium text-16px">
                        <span className="h-14px md:text-xl text-4xl"><span className="font-bold">✓</span>  포인트 전환 시 보유머니로 충전됩니다.</span>
                        <span className="h-14px md:text-xl text-4xl"><span className="font-bold">✓</span>  최소 10,000P 이상 신청 가능합니다.</span>
                        <span className="h-14px md:text-xl text-4xl"><span className="font-bold">✓</span>  자세한 문의사항은 고객센터를 이용해 주시기 바랍니다.</span>
                    </div>
                </div>

                <div className="flex items-center justify-center h-16px text-16px font-spoqaMedium text-gray-r7c7c7c tracking-tight mt-10px">
                    <span>사용 가능한 포인트:</span>
                    <span className="text-blue-r0056a6 ml-2px font-spoqaBold">278</span>
                    <span className="text-black">P</span>
                </div>

                <div className="h-150px w-full bg-gray-f9f9f9 border border-gray-dddddd rounded-2xl mt-10px flex flex-wrap flex-col items-center justify-center">
                    ...
                    <div className='w-full text-center mt-15px'>
                        <input 
                            placeholder="0"
                            className="flex-shrink-0 outline-none w-250px h-42px rounded-md border border-gray-dddddd px-10px font-spoqaMedium text-15px tracking-tight text-gray-r8c8c8c" 
                ...
                <div className="flex w-full mt-20px space-x-3px">
                    <button style={{padding: '0.1875rem'}} className="flex items-center justify-center h-52px w-1/2 rounded-lg bg-blue-r0070d9 hover:opacity-75">
                        <div 
                    ...
                    <button 
                        ...
                        className="flex items-center justify-center h-52px w-1/2 rounded-lg bg-blue-r004b8a hover:opacity-75"
