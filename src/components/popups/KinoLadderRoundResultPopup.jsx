...
import SpeedKinoResults from 'components/minigames/results/SpeedKinoResults';
...
const KinoLadderRoundResultPopup = ({setPopupOpen}) => {
    ...
    return (
        <div style={{height:"100vh", width: '77.625rem' ,borderTopLeftRadius: '4rem', borderTopRightRadius: '4rem'}} className="flex flex-col rounded-lg overflow-hidden">
            ...
            <div style={{paddingBottom: '1.875rem'}} className="w-full h-full bg-white">
                ...
                <SpeedKinoResults array={PowerballResultsArray} />
...
export default KinoLadderRoundResultPopup
