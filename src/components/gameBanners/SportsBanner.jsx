            ...
            <>
                {item.link ? (
                    ...
                    >
                        ...
                        <div style={{fontSize:"10px"}} className={`shadow-sm absolute z-20 right-6px w-64px h-24px rounded-full flex items-center justify-center text-white font-spoqaBold pt-px ${item.color}`}>{item.btnText}</div>
                    </a>
                ) : (
                    <button 
                        key={item.id} 
