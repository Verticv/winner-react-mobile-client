        ...
        <div style={{padding: '1.875rem', paddingTop: '0'}} className="flex flex-col items-center">
            ...
            <div style={{paddingLeft: '1.875rem', paddingTop: '1.875rem', paddingBottom: '1.875rem', borderWidth: '0.1875rem', marginBottom: '0.625rem'}} className="w-full rounded-2xl border border-red-e8c2b3 bg-red-ffe9de px-19px pt-17px">
                ...
                <div style={{marginTop: '1.625rem'}} className="flex flex-col text-red-ac6d6d tracking-tight font-spoqaMedium text-16px">
                    ...
                    <span style={{fontSize: '2.5rem', marginRight: '13.5rem', marginTop: '0.875rem'}} className="flex"><span style={{marginRight: '0.875rem'}} className="font-bold block">✓</span>  입금이 지연될 수 있으니 은행 점검 시간을 확인하신 후 점검 시간을 피해 신청해 주시기 바랍니다.</span>
            ...
            <div style={{padding: '0.9375rem', paddingBottom: '2.0625rem'}} className="mt-20px w-full rounded-2xl shadow-subNavbar">
                <div style={{padding: '2.0625rem', paddingTop: '1.375rem', paddingBottom: '1.1875rem'}} className="w-full rounded-2xl border border-gray-dddddd bg-gray-f9f9f9">
                    ...
                    <div style={{height: '0.1875rem', marginBottom: '1.875rem', marginTop: '0.9375rem'}} className="w-full bg-gray-bebebe my-5" />
                        ...
                        <button 
                            style={{width: "36.4375rem", height: '7.3125rem', padding: '0.1875rem', marginBottom: '1.5625rem', backgroundColor: "#bf4326"}} 
                ...
                <div style={{padding: '0 1.125rem'}} className="flex flex-col">
                    ...
                    <div style={{marginTop: '1.8125rem'}} className="flex items-end">
                        ...
                        <div className="flex w-full h-full">
                            ...
                            <button 
                                style={{height: '7.3125rem', padding: '0.1875rem'}} 
