    ...
    return (
        <div style={{margin: withMargin ? '0 1.875rem' : '0 3.875rem 0 0', width: withMargin ? '' : '73.875rem'}} className="bg-gray-f9f9f9 rounded-2xl border border-gray-dddddd flex flex-wrap items-center justify-center">
                ...
                <div style={{margin: '0.75rem 1.875rem', marginBottom: withBlackButton ? '0.75rem' : '0'}} className="flex w-full h-full items-center justify-between">
                    <div style={{width: '13.25rem', height: '7.3125rem', padding: '1px'}} className="flex items-center justify-center rounded-lg bg-blue-r004b8a hover:opacity-75">
                    ...
                    <div style={{width: '13.25rem', height: '7.3125rem', padding: '1px'}} className="flex items-center justify-center rounded-lg bg-blue-r2068b2 hover:opacity-75">
                    ...
                    <div style={{width: '13.25rem', height: '7.3125rem', padding: '1px'}} className="flex items-center justify-center rounded-lg bg-blue-r286fce hover:opacity-75">
                    ...
                    {has3MonthSearch && (
                        <div style={{width: '13.25rem', height: '7.3125rem', padding: '1px'}} className="flex items-center justify-center rounded-lg bg-blue-r177cce hover:opacity-75">
                    ...
                    {!hasIdSearch ? (
                        <div style={{width: '13.25rem', height: '7.3125rem', padding: '1px'}} className={`flex items-center justify-center rounded-lg ${withBlackButton? "bg-blue-r177cce" : "bg-gray-r171a1d"}  hover:opacity-75`}>
                ...
                <div style={{margin: '0.75rem 1.875rem', marginBottom: withMargin ? '1.875rem' : '1.375rem', marginTop: '0'}} className="flex w-full h-full items-center justify-between">
                    ...
                    {withBlackButton && (
                        <div style={{height: '7.3125rem', padding: '1px'}} className="flex w-full items-center justify-center rounded-lg bg-gray-r171a1d hover:opacity-75">
