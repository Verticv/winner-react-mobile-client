        ...
        return items.map((item, index) => {
            ...
            return (
                ...
                >
                    ...
                    >
                        <img style={{ width: imageWidth, marginTop: '0.6rem', WebkitUserDrag:"none", MozUserDrag:"none", userDrag:"none"}} className="h-full ml-2px w-10 object-contain bg-blue-100" src={item.icon} alt="" />
                        <div style={{marginTop: '-0.45rem'}} className='h-28 bg-red-100 '>
