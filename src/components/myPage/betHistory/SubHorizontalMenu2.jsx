...
const SubHorizontalMenu2 = ({
        ...
        return items.map((item, index) => {
            ...
            return (
                ...
                >
                    ...
                    >
                        <img style={{ width: !isMinigame ? imageWidth : "8.6rem", marginTop: '0.6rem', WebkitUserDrag:"none", MozUserDrag:"none", userDrag:"none"}} className={`h-full ml-2px object-contain`} src={item.icon} alt="" />
    ...
    return (
      <div id="container" className="flex justify-start items-start w-screen">
        <TabsList items={itemsArray} />
      </div>
    );
}

export default SubHorizontalMenu2
