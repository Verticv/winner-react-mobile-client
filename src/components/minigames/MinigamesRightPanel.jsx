                        ...
                        {selectedOption[0].buttonType && (
                            ...
                            >
                                ...
                                {selectedOption[0].tailSide && (
                                    <div style={{width: '3.75rem', height: '3.75rem'}} className={`${selectedOption[0].tailSide === "left" ? "left-4 pr-1" : "right-4"} absolute w-22px h-22px rounded-full bg-black  mt-1 z-20 top-4 flex items-center justify-center`}>
