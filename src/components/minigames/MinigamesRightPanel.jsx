                        ...
                        {selectedOption[0].buttonType && (
                            ...
                            >
                                ...
                                {selectedOption[0].tailSide && (
                                    <div style={{width: '3.75rem', height: '3.75rem'}} className={`${selectedOption[0].tailSide === "left" ? "left-4 pr-1  mt-px" : "right-4 mt-px"} absolute w-22px h-22px rounded-full bg-black  z-20 top-4 flex items-center justify-center`}>
