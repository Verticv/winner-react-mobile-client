                    ...
                    <div style={{
                        ...
                        <div style={{marginRight: '1.875rem'}} className="flex flex-col items-center ml-5">
                            ...
                            >
                                ...
                                <div style={{width: '3.75rem', height: '3.75rem'}} className="absolute rounded-full bg-black flex-shrink-0 z-20 left-4 top-4 flex items-center justify-center">
                        ...
                        <div style={{marginRight: '1.875rem'}} className="flex flex-col items-center">
                            ...
                            >
                                ...
                                <div style={{width: '3.75rem', height: '3.75rem'}} className="absolute rounded-full bg-black flex-shrink-0 z-20 right-4 top-4 flex items-center justify-center">
