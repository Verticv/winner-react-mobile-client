...
const MoneyPage = ({isAuthenticated, setAuthenticated}) => {
    ...
    return (
        <div style={{maxWidth: '1242px'}} className="relative w-full flex flex-col justify-center limit:overflow-x-hidden">
            ...
            <div style={{padding: '1.875rem', paddingBottom: '3.75rem'}} className="flex flex-col items-start limit:items-center w-full h-full">

            <div style={{paddingBottom : '1.875rem'}} className="w-full relative top-0 z-40">
